...
class Graph:
    def __init__(self, graph: dict = {}, undirected: bool = True, unweighted: bool = True) -> None:
    ...
    def add_edge(self, _from, _to, weigth = 1):
    ...
    def edgesOf(self, vertice, n =True):
    ...
    def allEdges(self, undirected=False) -> list:
        allEdge = []
...
if __name__ == '__main__':
    ...
    G.add_edge(1, 2, 5, undirected=True)
    G.add_edge(1, 3, 5, undirected=True)
    G.add_edge(2, 3, 5)
    G.add_edge(4, 4, 8)
    # G.add_edge(4, 2, 5)
    # G.add_edge(4, 3, 5)
